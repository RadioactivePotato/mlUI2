async function multiliveries() {
  ...
  let currentPanelOrigin = "https://ariakim-taiyo.github.io/MLUI/";
  let currentPanelHost = "https://ariakim-taiyo.github.io";
  let opened = false;
  let livObj;
  ...
  function changeLivery(livery) {
    ...
    if (livery === "inv") {
      ...
      ui.notification.show("Invalid client, please use the original code.");
      return;
    }
  ...
  window.addEventListener('message', function(e) {
    ...
    if (e.origin !== currentPanelHost & e.origin !== currentPanelOrigin) return;
    if (e.data === "test") {mlui.postMessage(btoa(multiliveries.toString()), "*"); return;}
    changeLivery(e.data);
  } , false);
  ...
  buttonDiv.addEventListener("click", function() {
    ...
    if (opened) { 
     ...
     mlui = window.open(currentPanelOrigin, "_blank", "height=1000,width=1500");
    opened = true;
